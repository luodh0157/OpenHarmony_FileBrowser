...
from PySide6.QtWidgets import QWidget, QHBoxLayout, QPushButton, QLineEdit, QLabel, QStyle, QCheckBox
...
class PathBarWidget(QWidget):
    ...
    def _update_breadcrumb(self):
        ...
        for part in parts:
            ...
            btn.clicked.connect(lambda checked, p=current_path: self._on_breadcrumb_click(p))
