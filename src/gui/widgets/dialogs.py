...
class RenameDialog(QDialog):
    ...
    def __init__(self, current_name: str, parent=None):
        ...
        self.info_label = QLabel(language_manager.tr('dialogs.rename_text', name=current_name))
        ...
        form_layout.addRow(language_manager.tr('dialogs.rename_new_name'), self.name_edit)
        
        layout.addLayout(form_layout)
        
        buttons = _create_translated_button_box(QDialogButtonBox.Ok | QDialogButtonBox.Cancel, self)
    ...
    def update_language(self, current_name: str = None):
        ...
        if current_name and hasattr(self, 'info_label'):
            self.info_label.setText(language_manager.tr('dialogs.rename_text', name=current_name))
...
class CreateFolderDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.name_edit = QLineEdit()
        self.name_edit.setPlaceholderText(language_manager.tr('dialogs.folder_name_placeholder'))
        form_layout.addRow(language_manager.tr('dialogs.create_folder_name'), self.name_edit)
...
class DeleteConfirmDialog(QDialog):
    ...
    def __init__(self, name: str, is_dir: bool = False, parent=None):
        ...
        self.info_label = QLabel(language_manager.tr('dialogs.delete_folder' if is_dir else 'dialogs.delete_file'))
        layout.addWidget(self.info_label)
        ...
        buttons = _create_translated_button_box(QDialogButtonBox.Yes | QDialogButtonBox.No, self)
        buttons.accepted.connect(self.accept)
        buttons.rejected.connect(self.reject)
        layout.addWidget(buttons)
