...
class DeviceManager(QObject):
    ...
    def __init__(self, hdc: Optional[HDCWrapper] = None, auto_start_monitoring: bool = False):
        """
    ...
    def start_monitoring(self, interval: int = 2000) -> bool:
        ...
        try:
            ...
            self.monitor_thread.device_disconnected.connect(self._on_device_disconnected)
